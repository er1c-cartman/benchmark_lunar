...
class RobotNavigator(Node):
    def __init__(self):
        ...
        self.goals = [
            {'x': 1.51, 'y': -6.52, 'z': -0.87, 'w': 0.47}, {'x': -7.34, 'y': -10.36, 'z': -0.98, 'w': -0.15}, {'x': -15.52, 'y': -11.9, 'z': 0.96, 'w': 0.25}, {'x': -23.59, 'y': -5.32, 'z': 0.81, 'w': 0.57},
              {'x': -27.42, 'y': 3.57, 'z': 0.81, 'w': 0.57}, {'x': -35.40, 'y': 4.37, 'z': 0.81, 'w': 0.58} # Example goals
        ]
